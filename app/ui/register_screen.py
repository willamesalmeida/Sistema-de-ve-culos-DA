...
class RegisterScreen(QWidget):
    ...
    def __init__(self, parent: QWidget = None):
        ...
        self._photo_path: str = None          # ← guarda o caminho completo (como antes)
        self._photo_preview: QLabel = None
        self._photo_label: QLabel = None
        self._build_ui()
    ...
    def _build_card_header(self) -> QWidget:
        ...
        icon_label = QLabel()
        icon_label.setPixmap(qta.icon("fa5s.user-plus", color="white").pixmap(QSize(18, 18)))
    ...
    def _build_photo_field(self) -> QWidget:
        container = QWidget()
        container.setStyleSheet("border: none;")
        layout = QVBoxLayout(container)
        layout.setContentsMargins(0, 0, 0, 0)
    ...
    def _select_photo(self) -> None:
        """Seleciona a foto e guarda o caminho completo (versão que estava funcionando)"""
        ...
        self._photo_path = path   # ← volta ao comportamento antigo
        ...
        self._photo_preview.setStyleSheet("border: none; border-radius: 26px;")
    ...
    def _on_save(self) -> None:
        ...
        try:
            driver = create_driver(
                ...
                photo_path=self._photo_path or None,   # ← usa o caminho completo
            )
            create_vehicle(
            ...
            if "UNIQUE constraint failed: vehicles.plate" in error:
                ...
                MessageDialog.error(self, f"Ocorreu um erro ao salvar:\n{error}")
